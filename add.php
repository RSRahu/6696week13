            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h3 class="text-center mb-0">เพิ่มข้อมูลพนักงาน</h3>
                    </div>
                    <div class="card-body">
                        <form id="employeeForm" action="save_employee.php" method="POST" novalidate>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="invalid-feedback">กรุณากรอกอายุระหว่าง 18-65 ปี</div>
                            </div>
                            <div class="mb-3">
                                <label for="salary" class="form-label">เงินเดือน</label>
                                <input type="number" class="form-control" id="salary" name="salary" min="15000" step="500" required>
                                <div class="invalid-feedback">กรุณากรอกเงินเดือน (ขั้นต่ำ 15,000)</div>
                            </div>
                            <div class="d-grid">
